...
class Customer(models.Model):
    user = models.OneToOneField(User, default=True, null=True, blank=True, on_delete=models.CASCADE)
...
class ShippingAddress(models.Model):
    customer = models.ForeignKey(Customer, default=True, on_delete=models.SET_NULL, null=True)
    order = models.ForeignKey(Order, on_delete=models.SET_NULL, null=True, blank=True)
